...
local Library = Update:Window("Makori","",Enum.KeyCode.RightControl);
...
Main:Toggle("Bypass Teleport",_G.Setting_table.KobenHeegeen,function(vu)
	Bypass = vu
...
Miscf:Label("Setting Rougth Sea")
...
Miscf:Dropdown("Selected Boats Rough Sea Quest",AllBoat,function(value)
BoatSeaQ = value
end)


_G.SelectLocalTeleportSea = "Sea6[???]"
Miscf:Dropdown("Select Sea",{"Sea1[Low]","Sea2[Medium]","Sea3[High]","Sea4[Extreme]","Sea5[Crazy]","Sea6[???]"},function(value)
...
_G.BoatSpeed = "350"
Miscf:Dropdown("Select Boat Speed",SpeedTable,function(value)
_G.BoatSpeed = value
end)

    
    Miscf:Toggle("Increase Boat Speed",_G.Setting_table.IncreaseBoatSpeed,function(vu)
...
Miscf:Toggle("Auto Rougth Sea Quest Fully [BETA]", _G.Setting_table.AutoRougthFully,function(vu)
         AutoRougthFully = vu
    ...
    pcall(function()
        while wait() do
            if game:GetService("Workspace").Map:FindFirstChild('KitsuneIsland') then
                YESS:Set('🟢: Kitsune is Spwan')
            else
                YESS:Set('🔴: Kitsune Not Found')
            end
        end
    end)
end)
    ...
    Miscf:Toggle("Teleport To Kitsune Island",_G.AutoFKitsune,function(value)
    AutoKisune = value
    _G.Setting_table.AutoKisune = value
    Update_Setting(getgenv()['MyName'])
    end)
    
    Miscf:Toggle("Auto Azuer Ember",_G.AutoAzuerEmber,function(value)
    AutoEmber = value
